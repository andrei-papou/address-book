...
describe('CreateContact.vue', () => {

	let vm;
	const Constructor = Vue.extend(CreateContact);
	...
	it('should contain submit method with expected behavior', () => {
		...
		vm.createContact = jest.fn();
		vm.redirectToList = jest.fn();
		vm.submit(data);
		expect(vm.createContact).toHaveBeenCalledWith({ birthday: '10/10/2017' });
